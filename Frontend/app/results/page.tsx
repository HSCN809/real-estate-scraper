...
export default function ResultsPage() {
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [platformFilter, categoryFilter, listingTypeFilter, subtypeFilter]);
                        ...
                        <form className="flex flex-wrap gap-3 items-center" role="search" aria-label="Konum filtreleri" onSubmit={(e) => e.preventDefault()}>
                            ...
                            {cityFilter.length > 0 && (
                                <button
                                    ...
                                    className="px-3 py-1.5 text-xs rounded-lg border border-red-500/30 text-red-300 bg-red-500/10 hover:bg-red-500/20 transition-colors"
