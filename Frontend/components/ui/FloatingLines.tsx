...
export default function FloatingLines({
  ...
  const getLineCountForWave = (waveType: string): number => {
  ...
  const getLineDistanceForWave = (waveType: string): number => {
  ...
  const topLC = enabledWaves.includes('top') ? getLineCountForWave('top') : 0;
  const middleLC = enabledWaves.includes('middle') ? getLineCountForWave('middle') : 0;
  const bottomLC = enabledWaves.includes('bottom') ? getLineCountForWave('bottom') : 0;

  const topLD = enabledWaves.includes('top') ? getLineDistanceForWave('top') * 0.01 : 0.01;
  const middleLD = enabledWaves.includes('middle') ? getLineDistanceForWave('middle') * 0.01 : 0.01;
  const bottomLD = enabledWaves.includes('bottom') ? getLineDistanceForWave('bottom') * 0.01 : 0.01;
